  ...
  return <section id="services" className="bg-secondary/20 py-px">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">From paid ads to ghostwriting; we use declassified government & military grade psychological manipulation to drive traffic & increase sales.</p>
        </div>
