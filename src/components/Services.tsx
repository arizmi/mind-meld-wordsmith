import { HatGlasses, Video, Target, Brain } from "lucide-react";
...
const Services = () => {
  ...
  return (
    <section id="services" className="bg-secondary/20 py-20">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            From paid advertising to ghostwriting; we use psychological triggers to influence specific emotional states that will drive sales.
          </p>
        </div>
